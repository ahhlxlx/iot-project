...
WIFI_SSID        = os.environ.get("WIFI_SSID",    "your_ssid")
WIFI_PASSWORD    = os.environ.get("WIFI_PASSWORD", "your_password")
GATEWAY_IP       = os.environ.get("GATEWAY_IP",   "192.168.1.100")
UDP_PORT         = 5005
...
def forward_packet(msg: dict):
    ...
    protocol = entry.protocol if entry else PROTOCOL_WIFI # we repurpose power_cost as protocol tag
