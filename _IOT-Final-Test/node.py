...
def udp_send(ip, port, obj):
    ...
    try:
        ...
        # If the send failed, check immediately whether WiFi has dropped.
        # Without this, wifi_active stays True for up to 60 s (retry interval),
        # causing every subsequent send to fail silently and inflating sent_count.
